...
<body>
  ...
  <nav class="nav">
    ...
    <ul class="nav-links">
      ...
      <li class="ab"><a href="../html/contactus.html">Contact Us</a></li>
  ...
  <div style="position:absolute; top:80px; width:100%;" class="homepage">

    <section class="section2">
      <div class="slideshow-container">
        <div class="slide fade">
          <img src="../img/slide/pic1.png" alt="Slide 1">
        </div>

        <div class="slide fade">
          <img src="../img/slide/pic2.png" alt="Slide 2">
        </div>

        <div class="slide fade">
          <img src="../img/slide/pic3.png" alt="Slide 3">
        </div>

        <div class="slide fade">
          <img src="../img/slide/pic4.png" alt="Slide 3">
        </div>
      </div>
    </section>
